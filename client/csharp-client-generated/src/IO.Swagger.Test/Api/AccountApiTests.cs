...
namespace IO.Swagger.Test
{
    ...
    public class AccountApiTests
    {
        ...
        public void AccountBalanceTest()
        {
            ...
            //AccountBalanceRequest body = null;
            //var response = instance.AccountBalance(body);
        ...
        /// </summary>
        [Test]
        public void AccountCoinsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //AccountCoinsRequest body = null;
            //var response = instance.AccountCoins(body);
            //Assert.IsInstanceOf<AccountCoinsResponse> (response, "response is AccountCoinsResponse");
        }
    }
