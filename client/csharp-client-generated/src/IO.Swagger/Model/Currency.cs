...
namespace IO.Swagger.Model
{
        ...
        public partial class Currency :  IEquatable<Currency>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="symbol">Canonical symbol associated with a currency. (required).</param>
        /// <param name="decimals">Number of decimal places in the standard unit representation of the amount. For example, BTC has 8 decimals. Note that it is not possible to represent the value of some currency in atomic units that is not base 10. (required).</param>
        ...
        public Currency(string symbol = default(string), int? decimals = default(int?), Object metadata = default(Object))
        {
            ...
            if (decimals == null)
            {
                throw new InvalidDataException("decimals is a required property for Currency and cannot be null");
            }
            else
            {
