...
namespace IO.Swagger.Api
{
        ...
        public interface ICallApi : IApiAccessor
    {
        ...
        ApiResponse<CallResponse> CallWithHttpInfo (CallRequest body);
        ...
        System.Threading.Tasks.Task<CallResponse> CallAsync (CallRequest body);
        ...
        System.Threading.Tasks.Task<ApiResponse<CallResponse>> CallAsyncWithHttpInfo (CallRequest body);
        ...
        public partial class CallApi : ICallApi
    {
        ...
        /// <returns></returns>
        public CallApi(IO.Swagger.Client.Configuration configuration = null)
        {
        ...
        /// <summary>
        /// Make a Network-Specific Procedure Call Call invokes an arbitrary, network-specific procedure call with network-specific parameters. The guidance for what this endpoint should or could do is purposely left vague. In Ethereum, this could be used to invoke &#x60;eth_call&#x60; to implement an entire Rosetta API interface for some smart contract that is not parsed by the implementation creator (like a DEX). This endpoint could also be used to provide access to data that does not map to any Rosetta models instead of requiring an integrator to use some network-specific SDK and call some network-specific endpoint (like surfacing staking parameters). Call is NOT a replacement for implementing Rosetta API endpoints or mapping network-specific data to Rosetta models. Rather, it enables developers to build additional Rosetta API interfaces for things they care about without introducing complexity into a base-level Rosetta implementation. Simply put, imagine that the average integrator will use layered Rosetta API implementations that each surfaces unique data.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body"></param>
        /// <returns>CallResponse</returns>
        public CallResponse Call (CallRequest body)
        {
             ApiResponse<CallResponse> localVarResponse = CallWithHttpInfo(body);
        ...
        /// <param name="body"></param>
        /// <returns>ApiResponse of CallResponse</returns>
        public ApiResponse< CallResponse > CallWithHttpInfo (CallRequest body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling CallApi->Call");
            ...
            return new ApiResponse<CallResponse>(localVarStatusCode,
                ...
                (CallResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(CallResponse)));
        }
        ...
        /// <param name="body"></param>
        /// <returns>Task of CallResponse</returns>
        public async System.Threading.Tasks.Task<CallResponse> CallAsync (CallRequest body)
        {
             ApiResponse<CallResponse> localVarResponse = await CallAsyncWithHttpInfo(body);
             return localVarResponse.Data;
        ...
        /// <param name="body"></param>
        /// <returns>Task of ApiResponse (CallResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<CallResponse>> CallAsyncWithHttpInfo (CallRequest body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling CallApi->Call");
